...
LITTLE_SUBCOIN_1 = f'❗️Для раскрутки вашего канала у вас должно быть минимум {LITTLE_SUBCOIN_TO_GET_SUBS} Sub монет!'
...
def SEND_CLIP_COUNT(user_id, link):
    ...
    send_sub_count = f'😀 Хорошо. Вы прислали {link}' \
                     ...
                     f'\nВаш баланс: {balance}' \
                     f'\nЕго хватит для заказа: {balance // clip_price_rub}'
...
def CONFIRM_ADDING_VIDEO_TO_PROMO(username, subcount, price):
    confirm_adding_channel = f'''Подтвердите добавление канала для продвижения:
                                \n\n📻 Канал: @{username}
                                \n\n📲 Количество подписчиков: {subcount}
                                \n\n💳 Цена: {price} Sub монет'''
...
NO_TT_VIDEO_TO_PROMO = f"😔 Пока нет видосов для продвижения. Но скоро будут!"

# TODO добавить в хуйню ссылку на видос
RECORD_THIS_TT_VIDEO = '''Снимите видео в TikTok:
                        \n1️⃣ Перейдите на видео по ссылке 👇, выбирите трек из видео ✔️
                         и снимите свое видео под него 🔝👁 (подождите около часа).
                        \n2️⃣ Возвращайтесь⚡️сюда, чтобы получить вознаграждение.'''
