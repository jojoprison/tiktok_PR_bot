...
START = 'Добро пожаловать в бот "TikTok_RiseBot". ' \
...
WRONG_TT_CLIP_LINK = 'Неправильная ссылка на TikTok видео, пришлите ее еще раз или вернитесь в 👤 Профиль!'
...
WITHDRAW_SUM_LESS_200 = 'Вывод средств доступен только от суммы 200 RUB и выше'
...
CHANNEL_FOR_MONEY = 'Канал с выплатами:\nhttps://t.me/zadanietiktok'
...
ADMIN_GET_DB_DATA = 'Ниже будет файл со всеми данными из базы'

ADMIN_GET_LOGS = 'Ниже будет файл с логами'
...
NEW_CLIP_TO_PROMO = 'Появился новый клип на продвижение!'
